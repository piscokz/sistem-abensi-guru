                            ...
                            @forelse ($daftarKelas as $kelas)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                        {{-- <a href="{{ route('guru-piket.jadwal.index', ['jadwal' => $kelas->id]) }}"
                                            class="text-green-400 mr-4 hover:text-green-600">Detail Jadwal</a> --}}

                                        <a href="{{ route('guru-piket.kelas.jadwal.index', ['kelas' => $kelas->id]) }}"
                                            class="text-green-400 mr-4 hover:text-green-600">
                                            Detail Jadwal
                                        </a>
